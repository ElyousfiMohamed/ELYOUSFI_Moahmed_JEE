...
import structure.Obj;
import userSimulation.dao.DaoImpl;
import userSimulation.metier.*;
...
public class Injector2 {
    ...
    public Injector2(String packName) throws InstantiationException, IllegalAccessException, InvocationTargetException {
